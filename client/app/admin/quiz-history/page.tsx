...
const QuizHistory = dynamic(
  () => import("../../components/Admin/Quiz/QuizHistory"),
  { ssr: false }
);

type Props = {};

const QuizHistoryPage = (props: Props) => {
  ...
  return (
    <div>
      <AdminProtected>
        <Heading
          title="EDUvibe - Quiz History"
          description="EDUvibe is a platform for students to learn and get help from teachers"
          keywords="Programming, MERN, Redux, Machine Learning, Quiz History"
        />

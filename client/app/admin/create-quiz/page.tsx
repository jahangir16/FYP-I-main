...
const CreateQuiz = dynamic(
  () => import("../../components/Admin/Quiz/CreateQuiz"),
  { ssr: false }
);
...
const CreateQuizPage = (props: Props) => {
  ...
  return (
    <div>
      <AdminProtected>
        <Heading
          title="EDUvibe - Create Quiz"
          description="EDUvibe is a platform for students to learn and get help from teachers"
          keywords="Programming, MERN, Redux, Machine Learning, Quiz Creation"
        />

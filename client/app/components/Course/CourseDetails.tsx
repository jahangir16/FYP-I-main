...
const CustomModal = dynamic(() => import("@/app/utils/CustomModal"), {
  ssr: false,
});
...
const CourseDetails = ({
  ...
  const priceInDollars = 0.5; // $0.50
  const priceInCents = priceInDollars * 100; // Convert to cents

  const originalPrice = data?.estimatedPrice || priceInCents; // Fallback to 50 cents if undefined
  const discountPrice = data?.price || 0; // Default to 0 if no discount is applied
  ...
  const discountPercentagePrice = discountPercentage.toFixed(0); // Round off to nearest whole number
  const isPurchased =
  ...
  // Function to determine the authentication component
            ...
            <div className="sticky top-[100px] left-0 z-50 w-full">
              ...
              <div className="flex items-center">
                ...
                {Number(discountPercentagePrice) > 0 && (
                  <h5 className="pl-3 text-[20px] mt-2 text-black dark:text-white">
              ...
              <div className="flex items-center">
                {user ? (
                  ...
                  <div
                    className={`${styles.button} !w-[180px] my-3 font-Poppins cursor-pointer !bg-blue-500`}
